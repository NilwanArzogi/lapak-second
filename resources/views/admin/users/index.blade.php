...
<div class="card">
    ...
    <div class="table-wrap">
        <table>
            <thead>
                <tr>
                    <th>#</th><th>Pengguna</th><th>Login Via</th>
                    <th>Role</th><th>Bergabung</th><th>Aksi</th>
                </tr>
            </thead>
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="6" style="text-align:center;padding:3rem;color:var(--muted);">Belum ada pengguna.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
    ...
    @if($users->hasPages())
        <div style="padding:1rem 1.5rem;border-top:1px solid var(--border);">{{ $users->links() }}</div>
    @endif
</div>
...
<div id="delete-modal" style="display:none;" class="modal-overlay">
    <div class="modal-box">
        ...
        <p class="modal-desc">Akun yang dihapus tidak bisa dikembalikan.</p>
